            ...
            <div class="orders">
                <div class="row">
                    <div class="col-xl-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">班级管理</h4>
                                <button onclick="window.location.href='${ctx}/clazz/adminUpdate'" style="width: 50px; position: absolute; top: 15px; right: 75px; margin: 0;" class="btn btn-success btn-sm btn-block">添加</button>
                                <button onclick="deleteClazz()" style="width: 50px; position: absolute; top: 15px; right: 15px; margin: 0;" class="btn btn-danger btn-sm btn-block">删除</button>
                            </div>
                            <div class="card-body--">
                                <div class="table-stats order-table ov-h">
                                    <form action="${ctx}/clazz/delete" id="clazzs" method="post">
                                    <table class="table ">
                                        <thead>
                                        <tr>
                                            <th class="serial">#</th>
                                        ...
                                        <tbody>
                                        <c:forEach items="${clazzs}" var="clazz" varStatus="statu">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button onclick="window.location.href='${ctx}/clazz/delete?id=${clazz.id}'"
