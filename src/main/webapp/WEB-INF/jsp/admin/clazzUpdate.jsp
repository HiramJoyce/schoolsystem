                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">班级信息</strong>
                        </div>
                        <div class="card-body">
                            <div id="pay-invoice">
                                <div class="card-body" style="width: 500px; margin: auto; float: none;">
                                    <form action="${ctx}/clazz/adminUpdate" method="post" novalidate="novalidate">
                                        <input type="hidden" name="id" value="${clazz.id}">
                                        <div class="form-group has-success">
                                            <label for="cc-name" class="control-label mb-1">名称</label>
                                            <input id="cc-name" name="clazzName" type="text" value="${clazz.clazzName}" class="form-control cc-name valid" data-val="true" data-val-required="" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name">
