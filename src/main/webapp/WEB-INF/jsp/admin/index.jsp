                    ...
                    <div class="col-xl-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button onclick="window.location.href='${ctx}/teacher/adminUpdate'" style="width: 50px; position: absolute; top: 15px; right: 75px; margin: 0;" class="btn btn-success btn-sm btn-block">添加</button>
                                <button onclick="deleteTeacher()" style="width: 50px; position: absolute; top: 15px; right: 15px; margin: 0;" class="btn btn-danger btn-sm btn-block">删除</button>
                            </div>
                            <div class="card-body--">
                                <div class="table-stats order-table ov-h">
                                    <form action="${ctx}/teacher/delete" id="teachers" method="post">
                                    <table class="table ">
                                        <thead>
                                        <tr>
                                            <th class="serial">#</th>
