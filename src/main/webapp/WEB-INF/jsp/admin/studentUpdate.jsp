                        ...
                        <div class="card-body">
                            <div id="pay-invoice">
                                <div class="card-body" style="width: 500px; margin: auto; float: none;">
                                    <form action="${ctx}/student/adminUpdate" method="post" novalidate="novalidate">
                                        <input type="hidden" name="id" value="${student.id}">
                                        <div class="form-group has-success">
                                            <label for="cc-name" class="control-label mb-1">姓名</label>
                                            <input id="cc-name" name="studentName" type="text" value="${student.studentName}" class="form-control cc-name valid" data-val="true" data-val-required="" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name">
                                            <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="cc-number" class="control-label mb-1">编号</label>
                                            <input id="cc-number" name="studentNum" type="text" class="form-control cc-number identified visa" value="${student.studentNum}" data-val="true">
