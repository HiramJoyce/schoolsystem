                        ...
                        <div class="card-body">
                            <div id="pay-invoice">
                                <div class="card-body" style="width: 500px; margin: auto; float: none;">
                                    <form action="${ctx}/teacher/adminUpdate" method="post" novalidate="novalidate">
                                        <input type="hidden" name="id" value="${teacher.id}">
                                        <div class="form-group has-success">
                                            <label for="cc-name" class="control-label mb-1">姓名</label>
                                            <input id="cc-name" name="teacherName" type="text" value="${teacher.teacherName}" class="form-control cc-name valid" data-val="true" data-val-required="" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name">
                                            <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="cc-number" class="control-label mb-1">编号</label>
                                            <input id="cc-number" name="teacherNum" type="text" class="form-control cc-number identified visa" value="${teacher.teacherNum}" data-val="true">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-password" name="teacherPassword" type="password" class="form-control" value="${teacher.teacherPassword}" data-val="true">
                                            <span class="help-block" data-valmsg-for="cc-number"
                                                  data-valmsg-replace="true"></span>
                                        </div>
                                        <div>
