                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">学生评分</strong>
                        </div>
                        <div class="card-body">
                            <div id="pay-invoice">
                                <div class="card-body" style="width: 500px; margin: auto; float: none;">
                                    <form action="${ctx}/course/teacherScore" method="post" novalidate="novalidate">
                                        <input type="hidden" name="scoreStudentId" value="${student.id}">
                                        <input type="hidden" name="scoreCourseId" value="${course.id}">
                                        <div class="form-group has-success">
                                            <label for="cc-name" class="control-label mb-1">姓名</label>
                                            <input id="cc-name" name="teacherName" type="text" disabled value="${student.studentName}" class="form-control cc-name valid" data-val="true" data-val-required="" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name">
                                            <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="cc-number" class="control-label mb-1">学号</label>
                                            <input id="cc-number" name="teacherNum" type="text" disabled class="form-control cc-number identified visa" value="${student.studentNum}" data-val="true">
                                            <span class="help-block" data-valmsg-for="cc-number"
                                                  data-valmsg-replace="true"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="cc-course" class="control-label mb-1">课程</label>
                                            <input id="cc-course" name="teacherNum" type="text" disabled class="form-control cc-number identified visa" value="${course.courseName}" data-val="true">
                                            <span class="help-block" data-valmsg-for="cc-number"
                                                  data-valmsg-replace="true"></span>
                                        </div>
                                        <div class="form-group has-success">
                                            <label for="cc-score" class="control-label mb-1">评分</label>
                                            <input id="cc-score" name="scoreScore" type="text" value="" class="form-control cc-name valid" data-val="true" data-val-required="" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name">
                                            <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                        </div>
                                        <span style="color: grey; font-size: 13px;">重复评分无效</span>
                                        <div>
                                            <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                <i class="fa fa-lock fa-lg"></i>&nbsp;
                                                <span id="payment-button-amount">提交评分</span>
                                            </button>
                                        </div>
                                    </form>
                                </div>
